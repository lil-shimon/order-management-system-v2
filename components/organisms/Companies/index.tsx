...
const CompanyList: FC<CompanyProps> = ({ data }) => {

  const { handleMoveToCreate, handleMoveToEdit } = useQueryCompany();
          ...
          >
            ...
            <td className="px-6 py-4 text-right">
              <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                 onClick={() => handleMoveToEdit(company)}
              >
                Edit
              </a>
            </td>
...
export const CompanyListMemo = memo(CompanyList);
